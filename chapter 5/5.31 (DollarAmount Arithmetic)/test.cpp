...
int main() {
   ...
   DollarAmount d3{137, 24};
   d3.divide(7);
   cout << "\n137.24 / 7 = ";
   cout << endl << d3.toString() << endl; // 19.6057 is rounded to 19.61
   cout << "note: 19.6057 is rounded to 19.61\n" << endl;
   
   DollarAmount d4{59, 64};
   d4.divide(11);
   cout << "59.64 / 11 = ";
   cout << endl << d4.toString() << endl; // 5.4218 is rounded to 5.42
   cout << "note: 5.4218 is rounded to 5.42\n" << endl;
}
